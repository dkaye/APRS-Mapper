...
**Version:** Server & Displays (v1.12); iGates (v5.0)
...
5. [APRS Server (v1.12)](#aprs-server-v112)
   - [Cloudflare Tunnel](#cloudflare-tunnel)
6. [Display Pis (v1.12)](#display-pis-v112)
...
└────────────────┬─────────────────────┘
                 │ TCP 14580
┌────────────────▼─────────────────────┐
│       APRS Server  (aprs-pi)         │  Pi 4 · v1.12
