...
| **Accuracy** | **Fast** keeps up with a busy net in real time. **Careful** is more accurate and slower — on a busy frequency the log falls further behind the radio as it goes. |
