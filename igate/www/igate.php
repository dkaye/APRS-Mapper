<?php
/**
 * igate.php — K6DRK iGate v5.2 main iGate status and packet log page
 *
...
<input id="refresh" name="refresh" type="checkbox"> Refresh every <B><?php echo $refresh ?> msec &nbsp;&nbsp;&nbsp;*=non-MARS</B>
