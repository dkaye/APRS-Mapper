...
# dw-foundsdr.py — MARS APRS iGate (direwatch)
#
# Shown on the TFT display when an SDR is found; reboots after a brief message.
#
...
y += font.getbbox(Line3)[3]
draw.text((x, y), Line4, font=font, fill="#FFFFFF")
y += font.getbbox(Line4)[3]
