#!/usr/bin/env bash
# iGate configuration wizard — K6DRK iGate v5.2
#
...
echo ""
echo -e "${CYAN}╔══════════════════════════════════════════╗${RESET}"
echo -e "${CYAN}║        iGate v5.2 — Configuration        ║${RESET}"
echo -e "${CYAN}╚══════════════════════════════════════════╝${RESET}"
echo ""
...
sed -i "s|comment=\"[^\"]*\"|comment=\"iGate 5.2 by $BASE_CALL, $LOCATION\"|" "$DIREWOLF_CONF"
if [ -n "$FILTER_EXPR" ]; then
